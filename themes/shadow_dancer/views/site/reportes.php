...
<div class="dashboardIcons span-16">
    ...
    <div class="dashIcon span-3">
        ...
        <div class="dashIconText "><a href="<?php echo Yii::app()->request->baseUrl.'/index.php?r=guias/asigxf'; ?>">Asignaciones del periodo</a></div>
    </div>
    ...
    <div class="dashIcon span-3">
        ...
        <div class="dashIconText"><a href="<?php echo Yii::app()->request->baseUrl.'/index.php?r=guias/asigxo'; ?>">Asignaciones del origen</a></div>
    </div>
    ...
    <div class="dashIcon span-3">
        ...
        <div class="dashIconText"><a href="<?php echo Yii::app()->request->baseUrl.'/index.php?r=origenes/bajxf'; ?>">Bajas del periodo</a></div>
    </div>
    ...
    <div class="dashIcon span-3">
        ...
        <div class="dashIconText"><a href="<?php echo Yii::app()->request->baseUrl.'/index.php?r=guias/bajxd'; ?>">Bajas del destino</a></div>
    </div>
    ...
    <div class="dashIcon span-3">
        ...
        <div class="dashIconText"><a href="<?php echo Yii::app()->request->baseUrl.'/index.php?r=guias/bajxu'; ?>">Bajas del usuario</a></div>
    </div>
