...
<?php echo CHtml::form(CHtml::normalizeUrl(''), 'post'); ?>
	...
	<div class="row">
		<?php echo CHtml::activeLabel($modelasigna,'kilaje'); ?>
		<?php echo CHtml::activeTextField($modelasigna, 'kilaje', array('size'=>12,'maxlength'=>3)) ?>
	</div>
		...
		<?php
			...
			$this->widget('zii.widgets.jui.CJuiDatePicker',
				array(
					...
					'value'=>Yii::app()->dateFormatter->formatDateTime(CDateTimeParser::parse($modelasigna->fecha_asig, 'yyyy-MM-dd'),'medium',null),
					'htmlOptions'=>array(
						//'size'=>10,
