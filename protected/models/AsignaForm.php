...
class AsignaForm extends CFormModel
{
	...
	{
		return array(
			array('factura, folio_ini, folio_fin, zona, kilaje, asignado, id_origen', 'required'),
			array('folio_ini, folio_fin, zona, kilaje, id_origen', 'numerical', 'integerOnly'=>true),
			//array('fecha_asig', 'date', 'format'=>'dd-mm-yy'),
			array('kilaje', 'length', 'max'=>3),
